...
void ATheGauntlet_2Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATheGauntlet_2Character::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ATheGauntlet_2Character::Look);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATheGauntlet_2Character::Look);
	}
	else
	{
...
void ATheGauntlet_2Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATheGauntlet_2Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATheGauntlet_2Character::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
